...
const App = () => {
  ...
  // The middle key represents 50% of the way through each loop of the animation.
  // You can declare an offset to change from 50% to 30% for example.
  let aliceTub = [
  ...
  // Iterations instead of iteration-count.
  // The default easing is linear in the Web Animations API.
  let aliceTiming = {
    duration: 3000,
    iterations: Infinity // instead of the CSS 'infinite'
  }
  ...
  return (
    <div className="App">
      <header className="App-header">
        <h1>Press the buttons to interact with the animation</h1>
